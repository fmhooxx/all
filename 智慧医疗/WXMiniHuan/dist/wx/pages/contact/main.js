...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_2d73565e_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_fileExt_template_wxml_script_js_style_wxss_platform_wx_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(164);
var disposed = false
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_2d73565e_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_fileExt_template_wxml_script_js_style_wxss_platform_wx_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2d73565e", Component.options)
  } else {
    hotAPI.reload("data-v-2d73565e", Component.options)
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_map__ = __webpack_require__(149);
  ...
  methods: {
    ...
    initFriendsList: function initFriendsList() {
      ...
      wx.$app.getFriendList({
        ...
        var tempMap = new __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_map___default.a();
        res.data.forEach(function (friend) {
          return tempMap.set(friend.userID, friend);
        });
        var groupedFriends = _this2.groupingFriendList([].concat(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_toConsumableArray___default()(tempMap.values())));
    ...
    groupingFriendList: function groupingFriendList(friends) {
      ...
      friends.forEach(function (friend) {
        ...
        var firstWord = Object(__WEBPACK_IMPORTED_MODULE_2__utils_index__["d" /* pinyin */])(name)[0].toUpperCase();
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-2d73565e", esExports)
  }
}

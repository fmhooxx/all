...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_63329ace_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_fileExt_template_wxml_script_js_style_wxss_platform_wx_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(174);
var disposed = false
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_63329ace_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_fileExt_template_wxml_script_js_style_wxss_platform_wx_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-63329ace", Component.options)
  } else {
    hotAPI.reload("data-v-63329ace", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  computed: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_1_vuex__["c" /* mapState */])({
    ...
    quitText: function quitText() {
      if (this.groupProfile && this.groupProfile.type !== wx.TIM.TYPES.GRP_PRIVATE && this.groupProfile.selfInfo && this.groupProfile.selfInfo.role === wx.TIM.TYPES.GRP_MBR_ROLE_OWNER) {
        return '退出并解散群聊';
      }
      return '退出群聊';
    },
  ...
  methods: {
    ...
    handleMuteSwitch: function handleMuteSwitch(event) {
      var _this3 = this;

      if (this.isAdminOrOwner) {
        var muteAllMembers = event.mp.detail.value;
        wx.$app.updateGroupProfile({
          muteAllMembers: muteAllMembers,
          groupID: this.groupProfile.groupID
        }).then(function (imResponse) {
          var muteAllMembers = imResponse.data.group.muteAllMembers;
          if (muteAllMembers) {
    ...
    handleOk: function handleOk() {
      ...
      wx.$app.addGroupMember({
        ...
        if (res.data.successUserIDList.length > 0) {
          ...
          _this4.userID = '';
          _this4.addMemberModalVisible = false;
        }
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return (_vm.groupProfile) ? _c('div', {
    ...
    attrs: {
      "color": "#006fff",
      "disabled": !_vm.isAdminOrOwner,
      "eventid": '3'
    },
    on: {
      "change": _vm.handleMuteSwitch,
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-63329ace", esExports)
  }
}

...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_get_iterator__ = __webpack_require__(117);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_get_iterator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_get_iterator__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__emojiMap__ = __webpack_require__(73);
    ...
    switch (left) {
      case 0:
        if (right === -1) {
          ...
          if (__WEBPACK_IMPORTED_MODULE_1__emojiMap__["a" /* emojiMap */][_emoji]) {
            renderDom.push({
              name: 'img',
              src: __WEBPACK_IMPORTED_MODULE_1__emojiMap__["c" /* emojiUrl */] + __WEBPACK_IMPORTED_MODULE_1__emojiMap__["a" /* emojiMap */][_emoji]
            });
...
function parseGroupTip(message) {
  ...
  switch (payload.operationType) {
    ...
    case GROUP_TIP_TYPE.MEMBER_INFO_MODIFIED:
      ...
      try {
        for (var _iterator = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_get_iterator___default()(payload.memberList), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
function parseCustom(message) {
  ...
  if (Object(__WEBPACK_IMPORTED_MODULE_2__index__["c" /* isJSON */])(data)) {
    data = JSON.parse(data);
    if (data.hasOwnProperty('version') && data.version === 3) {
      var tip = void 0;
      var time = Object(__WEBPACK_IMPORTED_MODULE_2__index__["a" /* formatDuration */])(data.duration);
      switch (data.action) {
        case -2:
          tip = '异常挂断';
          break;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_tim_wx_sdk__ = __webpack_require__(56);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_dayjs_locale_zh_cn__ = __webpack_require__(123);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_cos_wx_sdk_v5__ = __webpack_require__(124);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__static_utils_GenerateTestUserSig__ = __webpack_require__(54);
...
tim.on(__WEBPACK_IMPORTED_MODULE_2_tim_wx_sdk___default.a.EVENT.NET_STATE_CHANGE, netStateChange, this);
tim.on(__WEBPACK_IMPORTED_MODULE_2_tim_wx_sdk___default.a.EVENT.MESSAGE_READ_BY_PEER, onMessageReadByPeer);
...
function checkoutNetState(state) {
  switch (state) {
    case __WEBPACK_IMPORTED_MODULE_2_tim_wx_sdk___default.a.TYPES.NET_STATE_CONNECTED:
      return { title: '已接入网络', duration: 2000 };
    case __WEBPACK_IMPORTED_MODULE_2_tim_wx_sdk___default.a.TYPES.NET_STATE_CONNECTING:
      return { title: '当前网络不稳定', duration: 2000 };
    case __WEBPACK_IMPORTED_MODULE_2_tim_wx_sdk___default.a.TYPES.NET_STATE_DISCONNECTED:
...
function netStateChange(event) {
  ...
  __WEBPACK_IMPORTED_MODULE_3__store_index__["a" /* default */].commit('showToast', checkoutNetState(event.data.state));
}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0d675e72", Component.options)
  } else {
    hotAPI.reload("data-v-0d675e72", Component.options)
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_group__ = __webpack_require__(120);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__modules_user__ = __webpack_require__(121);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__modules_global__ = __webpack_require__(122);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_toConsumableArray__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_tim_wx_sdk__ = __webpack_require__(56);
